...
|-------------|--------|----------|
| `{{SKILL_DIR}}` | `~/.claude/skills/презентация` | Путь к папке этого скилла |
| `{{PRESENTATIONS_DIR}}` | `~/presentations` | Локальная папка для сохранения презентаций |
...
- Шаблон HTML: `{{SKILL_DIR}}/references/template.html`
- Макеты слайдов: `{{SKILL_DIR}}/references/slide-layouts.md`
- Стиль Minimalism: `{{SKILL_DIR}}/references/styles/minimalism.css`
- Стиль Dark Mode: `{{SKILL_DIR}}/references/styles/dark-mode.css`
- Стиль Neobrutalism: `{{SKILL_DIR}}/references/styles/neobrutalism.css`
- Стиль Avant: `{{SKILL_DIR}}/references/styles/avant.css`
- Галерея шаблонов: `{{SKILL_DIR}}/references/gallery.html`
...
```
Read: {{SKILL_DIR}}/references/slide-layouts.md
Read: {{SKILL_DIR}}/references/styles/{выбранный_стиль}.css
```
...
```
Read: {{SKILL_DIR}}/references/template.html
```
...
```bash
mkdir -p "{{PRESENTATIONS_DIR}}/YYYY-MM-DD_slug"
```
...
```bash
open "{{PRESENTATIONS_DIR}}/YYYY-MM-DD_slug/index.html"
```
...
scp -i {{SSH_KEY}} "{{PRESENTATIONS_DIR}}/YYYY-MM-DD_slug/index.html" {{VPS_HOST}}:{{DEPLOY_BASE_PATH}}/YYYY-MM-DD-Slug/index.html
...
```bash
open "{{SKILL_DIR}}/references/gallery.html"
```
